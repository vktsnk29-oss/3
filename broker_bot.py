...
GEOCODE_UA = os.getenv("GEOCODE_UA", "tg-broker-bot/inline-geo/3.0 (contact: set-your-email@example.com)")
...
def build_app():
    ...
    start_conv = ConversationHandler(
        ...
        # per_message=False (default) — позволяет обрабатывать текстовые шаги
    )
